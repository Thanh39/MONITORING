...
public class ClientFrame extends JFrame implements ActionListener, ISocketListener {
	...
	public ClientFrame() {
		...
		searchLabel.setBounds(100, 250, 150, 25);
		searchInput.setBounds(100, 300, 150, 25);
		searchButton.setBounds(100, 350, 150, 25);
		...
		listScrollPane.setBounds(550, 100, 300, 350);
		this.add(listScrollPane);

		// JB
		downLoadFile = new JButton("Download File");
		downLoadFile.setBounds(100, 400, 150, 25);
		this.add(downLoadFile);

		uploadFileButton = new JButton("Upload File");
		uploadFileButton.setBounds(100, 450, 150, 25);
		this.add(uploadFileButton);
		jb = new JProgressBar(0, 100);
		jb.setBounds(100, 500, 150, 25);
		jb.setValue(48);
